...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AEscapeBuildingGameModeBase()
	{
		...
		if (!OuterClass)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
				...
				{ "IncludePath", "EscapeBuildingGameModeBase.h" },
				{ "ModuleRelativePath", "EscapeBuildingGameModeBase.h" },
				{ "ShowCategories", "Input|MouseInput Input|TouchInput" },
			};
#endif
			static const FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
				TCppClassTypeTraits<AEscapeBuildingGameModeBase>::IsAbstract,
			};
			static const UE4CodeGen_Private::FClassParams ClassParams = {
				&AEscapeBuildingGameModeBase::StaticClass,
	...
	IMPLEMENT_CLASS(AEscapeBuildingGameModeBase, 2302634952);
